    ...
    return function (e) {
        ...
        !function () {
            ...
            if (Object.defineProperty) {
                var A = t({}), C = "undefined" == typeof document || t(document.createElement("div"));
                if (!A || !C)var E = Object.defineProperty
            }
            if (!Object.defineProperty || E) {
                var y = "Property description must be an object: ", F = "Object.defineProperty called on non-object: ", b = "getters & setters can not be defined on this javascript engine";
            ...
            if (Object.preventExtensions || (Object.preventExtensions = function (e) {
                ...
                var S = !0, D = ["toString", "toLocaleString", "valueOf", "hasOwnProperty", "isPrototypeOf", "propertyIsEnumerable", "constructor"], B = D.length;
                for (var $ in{toString: null})S = !1;
            ...
            var k = "	\n\f\r ¬†·ö?·†é‚??‚ÄÅ‚?Ç‚?É‚?Ñ‚?Ö‚?Ü‚?á‚?à‚?â‚?ä‚?Ø‚Åü„Ä?\u2028\u2029Ôª?";
            if (!String.prototype.trim || k.trim()) {
                k = "[" + k + "]";
                var _ = new RegExp("^" + k + k + "*"), L = new RegExp(k + k + "*$");
            ...
            var i = e("../lib/event"), n = e("../lib/useragent"), o = e("../lib/dom"), r = e("../lib/lang"), s = n.isChrome < 18, a = n.isIE, l = function (e, t) {
                ...
                var $ = !1, k = function (e) {
                    B && (e = B(e), B = null), f ? (l(), e && t.onPaste(e), f = !1) : e == d.charAt(0) ? $ ? t.execCommand("del", {source: "ace"}) : t.execCommand("backspace", {source: "ace"}) : (e.substring(0, 2) == d ? e = e.substr(2) : e.charAt(0) == d.charAt(0) ? e = e.substr(1) : e.charAt(e.length - 1) == d.charAt(0) && (e = e.slice(0, -1)), e.charAt(e.length - 1) == d.charAt(0) && (e = e.slice(0, -1)), e && t.onTextInput(e)), $ && ($ = !1)
                }, _ = function () {
                    if (!p) {
                        var e = u.value;
                        k(e), c()
            ...
            (function () {
                this.tokenRe = new RegExp("^[" + r.packages.L + r.packages.Mn + r.packages.Mc + r.packages.Nd + r.packages.Pc + "\\$_]+", "g"), this.nonTokenRe = new RegExp("^(?:[^" + r.packages.L + r.packages.Mn + r.packages.Mc + r.packages.Nd + r.packages.Pc + "\\$_]|\\s])+", "g"), this.getTokenizer = function () {
                    ...
                    if (this.lineCommentStart) {
                        ...
                        var g = this.blockComment.start, A = this.blockComment.end, d = new RegExp("^(\\s*)(?:" + s.escapeRegExp(g) + ")"), C = new RegExp("(?:" + s.escapeRegExp(A) + ")\\s*$"), m = function (e, t) {
                            v(e, t) || (!a || /\S/.test(e)) && (r.insertInLine({
                                row: t,
                                column: e.length
                            }, A), r.insertInLine({row: t, column: c}, g))
                        }, f = function (e, t) {
                            var i;
            ...
            (function () {
                this.set = function (e) {
                    ...
                    } else for (var v = 0; v < r.length; v++)for (var w = i.getMatchOffsets(r[v], a), d = 0; d < w.length; d++) {
                        var A = w[d];
            ...
            var i = e("./lib/oop"), n = e("./lib/dom"), o = e("./lib/lang"), r = e("./lib/useragent"), s = e("./keyboard/textinput").TextInput, a = e("./mouse/mouse_handler").MouseHandler, l = e("./mouse/fold_handler").FoldHandler, c = e("./keyboard/keybinding").KeyBinding, h = e("./edit_session").EditSession, u = e("./search").Search, d = e("./range").Range, g = e("./lib/event_emitter").EventEmitter, f = e("./commands/command_manager").CommandManager, p = e("./commands/default_commands").commands, m = e("./config"), v = e("./token_iterator").TokenIterator, w = function (e, t) {
            ...
            (function () {
                i.implement(this, r), this.EOF_CHAR = "¬∂", this.EOL_CHAR_LF = "¬¨", this.EOL_CHAR_CRLF = "¬§", this.EOL_CHAR = this.EOL_CHAR_LF, this.TAB_CHAR = "‚Ü?", this.SPACE_CHAR = "¬∑", this.$padding = 0, this.$updateEolChar = function () {
            ...
            var n = e("../lib/oop"), o = e("../lib/net"), r = e("../lib/event_emitter").EventEmitter, s = e("../config"), a = function (t, n, o, r) {
                ...
                try {
                    var c = n.src, h = i(21), u = new h([c], {type: "application/javascript"}), d = (window.URL || window.webkitURL).createObjectURL(u);
            ...
            function n(e) {
                ...
                if (0 === c) {
                    var h, u = e.editor, d = u.selection, g = u.inMultiSelectMode, f = e.getDocumentPosition(), p = d.getCursor(), m = e.inSelection() || d.isEmpty() && i(f, p), v = e.x, w = e.y, A = function (e) {
        ...
        (function (e, n) {
            ...
            t.parser = o, t.parse = function () {
                ...
                }()).readFileSync(i(20).join(e.cwd(), n[1]), "utf8"); else var r = i(!function () {
                    var e = new Error('Cannot find module "file"');
                    throw e.code = "MODULE_NOT_FOUND", e
                }()).path(i(!function () {
                    var e = new Error('Cannot find module "file"');
                    throw e.code = "MODULE_NOT_FOUND", e
                }()).cwd()), o = r.join(n[1]).read({charset: "utf-8"});
        ...
        i.nextTick = function () {
            ...
            var n = [];
            if (t) {
                var o = document.createElement("div"), r = new MutationObserver(function () {
                    var e = n.slice();
                    n.length = 0, e.forEach(function (e) {
                        e()
                    })
                });
                return r.observe(o, {attributes: !0}), function (e) {
        ...
        (function (e) {
            ...
            t.resolve = function () {
                ...
                for (var o = n(e.split("/")), r = n(i.split("/")), s = Math.min(o.length, r.length), a = s, l = 0; s > l; l++)if (o[l] !== r[l]) {
                    a = l;
                    break
                }
...
app.doc = {
    ...
    try {
        app.notify = new Notify, app.retriever = new FileRetriever({
            ...
            notify: app.notify
        }), app.store = new OnlineStore({url: "http://api.jsoneditoronline.org/v1/docs/", notify: app.notify});
